...
/**
 * Bootstrap class for the Vampire Paper plugin.
 ...
 */
public class VampireBootstrap implements PluginBootstrap {
     ...
     * @return The main VampirePlugin instance.
     */
    @Override
    public JavaPlugin createPlugin(PluginProviderContext context) {
        return new VampirePlugin();
    }
}
